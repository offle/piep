...
Vogelstimmen lokal erkennen

## Kurzbeschreibung / Promotional Text

Erkenne Vogelstimmen direkt auf deinem iPhone, speichere Funde in Sessions und entdecke deine Beobachtungen in Listen und auf der Karte.
...
Für neugierige Nutzer gibt es einen Expertenbereich mit anpassbaren Analyseprofilen und einem Benchmark für eigene Audio-Samples. So kannst du verschiedene Filtereinstellungen vergleichen und die Erkennung an deine Umgebung anpassen.

Wichtig: Die Erkennung läuft direkt auf deinem Gerät. Mikrofonaufnahmen werden von piep nicht auf einen Server hochgeladen. Ergebnisse sind Modellvorschläge und können falsch sein, deshalb zeigt piep Konfidenzwerte an und lässt dich falsche Treffer entfernen.
...
- Expertenprofile und Benchmark für eigene Samples
- Bildcache lokal löschen
- Alternative App Icons

## Keywords

Vögel,Vogelstimmen,BirdNET,Natur,Ornithologie,Birding,Vogelbeobachtung,Erkennung,Audio,Karte,Session
